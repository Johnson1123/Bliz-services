...
function Herosection() {
  return (
    <section className="h-[calc(100vh_-_160px)] min-h-[500px] landscape:sm:min-h-[450px] landscape:md:min-h-[650px] landscape:lg:min-h-[100vh] 3k:max-h-[800px] relative left-0 right-0 bg-white">
