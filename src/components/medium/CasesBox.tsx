...
function CasesBox({
  ...
  return (
    ...
    >
      <div className="absolute left-0 top-0 h-full w-full group-hover:translate-y-0  group-hover:bg-gradient-to-t from-slate-900/90 transition-all duration-[2s] via-slate-900/80 to-slate-700/60 bg-opacity-10 "></div>
